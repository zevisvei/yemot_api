...
class Yemot(YemotBase):
    ...
    def upload_file(
        ...
        if len(chunks) == 1:
            return self._upload_small_file(folder, blob, file_name, convert_audio, auto_numbering=auto_numbering, tts=tts)
        return self._upload_large_file(folder, chunks, file_name, total_size, convert_audio=convert_audio, auto_numbering=auto_numbering, tts=tts)
